                ...
                <div className='flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16'>
                    <div className='flex-1 space-y-6 lg:space-y-7'>
                        <div className='space-y-4 lg:space-y-5'>
                            <div className='flex items-center'>
                                ...
                                <h2 className='inline-block px-3 py-1.5 lg:px-4 lg:py-2 rounded-full bg-neutral-900 text-amber-400 font-medium text-sm backdrop-blur-sm border border-neutral-800/50'>
                                    <i className='bx bx-trending-up mr-1'> Next Generation</i>
                                </h2>
                            </div>
                            ...
                            Elevate your web project with our streamlined desig system powered by the latest
                            Tailwind CSS v4. Create stunning user experiance with state-of-the-art theme switching.
                            </p>
                        ...
                        <div className='flex flex-wrap gap-3 lg:gap-4'>
                            ...
                            <button className='px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 
                            dark:hover:bg-neutral-700 
                            border border-neutral-300
                            dark:border-neutral-700
                            text-neutral-900 
                            dark:text-white font-medium  flex items-center transition group'>
                        ...
                        <div className='flex flex-col sm:flex-row gap-5 sm:items-center pt-6 lg:pt-7 border-t border-neutral-200 dark:border-neutral-800'>
                            <div className='flex -space-x-3'>
                                ...
                                <img src="https://randomuser.me/api/portraits/women/23.jpg" alt="user" className='w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900 object-cover' />
                                <span className='flex items-center justify-center w-9 h-9 lg:w-10 lg:h-10 rounded-full border-2 border-white dark:border-neutral-900
                                bg-neutral-900 dark:bg-amber-500
                                    ...
                                    <div className='relative bg-white dark:bg-neutral-900 p-4 lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800'>
                                        <div className='flex items-center justify-between mb-3 lg:mb-4'>
                                            <div className='flex items-center gap-2'>
                                                ...
                                                <span className='w-2.5 h-2.5 lg:w-3 lg:h-3 rounded-full bg-amber-500'>
                                                </span>
                                        ...
                                        <div className='h-56 md:h-64 lg:h-60 xl:h-72 rouded-lg bg-neutral-100 dark:bg-amber-800 overflow-hidden relative '>
                                            ...
                                            <div className='absolute bottom-4 right-4'>
                                                <div className='w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-gradient-to-r from-amber-500 to-indigo-900 flex items-center justify-center text-white shadow-lg animate-pulse'>
